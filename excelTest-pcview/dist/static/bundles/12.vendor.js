...
var _class = function (_Handler) {
    ...
    _createClass(_class, [{
        ...
        value: function resolveTpl(tpl) {
            return __webpack_require__(281)("./" + tpl + ".html");
        }
    }, {
        key: "indexAfter",
        ...
        value: function selRole(args) {
            ...
            this.getAllConditions().then(function () {
                ...
                _this3.options.selectedRole = args;

                _this3.currentRoleId = args.objid;
                _this3.currentRoleName = args.objname;
                ...
                if (!roleid) {
                    $("#" + _this3.mcid + "_btnSure").attr('disabled', true);
                } else {
                    $("#" + _this3.mcid + "_btnSure").attr('disabled', false);
                }

                $("#" + _this3.mcid + "_currentRoleId").val(roleid);
                $("#" + _this3.mcid + "_currentRoleName").text(rolename);
                ...
                if (roleid) {
                    var url = "system/core/role/conditionsbyroleid/" + roleid;
                    $.ajax({
                        cache: false,
                        async: false, // 同步加载
                        type: "GET",
        ...
        value: function bindReset() {
            ...
            this.selRole(this.options.selectedRole);
        }
        ...
        value: function bindConditions() {
            ...
            var roleId = this.options.selectedRole.objid;

            var param = { "roleid": roleId, "conditionsid": conditions };
            var url = "system/core/authorize/bindroleconditions";
            $.ajax({
                cache: false,
                data: param,
                type: "POST",
                ...
                if (form.length > 0) {
                    ...
                    return this.render(args).then(function (data) {
                        new __WEBPACK_IMPORTED_MODULE_1_ezdev_pcview_components_table_Table__["default"]({
                            ...
                            buttonClickCallback: _this5.search.bind(_this5, args)
                        });
                    });
                } else {
                    throw new Error("参数无效，DOM中无法找到id为[" + args.form + "]的Form！");

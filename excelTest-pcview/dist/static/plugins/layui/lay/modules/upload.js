    ...
    Upload.prototype.init = function(){
        ...
        return elem.each(function(index, item){
            ...
            if(!options.unwrap){
                ...
                item.attr('lay-title') || options.title|| ('上传'+ (fileType[type]||'文件') )
                ) +'</span></div>';
            }
        ...
        var iframe = $('#'+elemIframe), timer = setInterval(function() {
            ...
            if(res){
                ...
                try {
                    ...
                    res = {};
                    //modify lhw 20170228 start 上传超过大小限制10M时，http500错误
                    //return layer.msg('请对上传接口返回JSON字符', msgConf);
                    return layer.msg('文件上传失败，请检查文件大小是否超过10M。', msgConf);
                    //modify lhw 20170228 end
                }

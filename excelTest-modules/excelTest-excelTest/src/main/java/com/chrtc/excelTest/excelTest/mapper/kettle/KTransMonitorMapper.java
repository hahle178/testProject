 ...
 **<p>KTransMonitorExample使用说明（下面以查询为例，更新、删除时的用法相同）：
 ...
 **List<KTransMonitor> list = selectByExample(example);
 **</p>
 */
@Mapper
public interface KTransMonitorMapper {
    ...
    /**
    * 获取符合example条件的k_trans_monitor信息的数量
    * @param example
    * @return
    */
    ...
    /**
    * 删除获取符合example条件的k_trans_monitor信息
    * @param example
    * @return
    */
    ...
    */
    ...
    /**
    * 插入k_trans_monitor信息，参数属性值是不是不为空都插入
    * @param record
    * @return
    */
    ...
    /**
    * 插入k_trans_monitor信息，参数属性值不为空的插入
    * @param record
    * @return
    */
    ...
    /**
    * 获取符合example条件的k_trans_monitor信息
    * @param example
    * @return
    */
    ...
    /**
    * 根据Id获取k_trans_monitor信息
    * @param id
    * @return
    */
    KTransMonitor selectByPrimaryKey(String id);

    /**
    * 根据example条件更新k_trans_monitor信息，仅仅更新参数属性值不为空的
    * @param record
    * @param example
    * @return
    */
    ...
    /**
    * 根据example条件更新k_trans_monitor信息
    * @param record
    * @param example
    * @return
    */
    ...
    /**
    * 根据主键更新k_trans_monitor信息，仅仅更新参数属性值不为空的
    * @param record
    * @return
    */
    ...
    */
    ...
    /**
    * 用分页方式获取k_trans_monitor信息
    * @param searchParams 查询参数
    * @return 列表
    */
    Paging findAllByPage(@Param("example") KTransMonitorExample searchParams, @Param("pageNum") int pageNumber, @Param("pageSize") int pageSize, @Param("sort") String sort);

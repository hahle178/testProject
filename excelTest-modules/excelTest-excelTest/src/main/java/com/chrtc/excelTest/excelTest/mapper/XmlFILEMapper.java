...
/**
 * Created by AUTO on 2018-06-14 17:04:20.
 **<p>XmlFILEExample使用说明（下面以查询为例，更新、删除时的用法相同）：
 ...
 **List<XmlFILE> list = selectByExample(example);
 **</p>
 */
@Mapper
public interface XmlFILEMapper {
    ...
    /**
    * 获取符合example条件的xmlFILE信息的数量
    * @param example
    * @return
    */
    int countByExample(XmlFILEExample example);

    /**
    * 删除获取符合example条件的xmlFILE信息
    * @param example
    * @return
    */
    int deleteByExample(XmlFILEExample example);
    ...
    */
    ...
    /**
    * 获取符合example条件的xmlFILE信息
    * @param example
    * @return
    */
    List<XmlFILE> selectByExample(XmlFILEExample example);
    ...
    * @return
    */
    XmlFILE selectByPrimaryKey(String id);

    /**
    * 根据example条件更新xmlFILE信息，仅仅更新参数属性值不为空的
    * @param record
    * @param example
    * @return
    */
    int updateByExampleSelective(@Param("record") XmlFILE record, @Param("example") XmlFILEExample example);

    /**
    * 根据example条件更新xmlFILE信息
    * @param record
    * @param example
    * @return
    */
    int updateByExample(@Param("record") XmlFILE record, @Param("example") XmlFILEExample example);

    /**
    * 根据主键更新xmlFILE信息，仅仅更新参数属性值不为空的
    * @param record
    * @return
    */
    ...
    * @return 列表
    */
    Paging findAllByPage(@Param("example") XmlFILEExample searchParams, @Param("pageNum") int pageNumber, @Param("pageSize") int pageSize, @Param("sort") String sort);
